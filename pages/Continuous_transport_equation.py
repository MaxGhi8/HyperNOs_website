...
def cont_tran_page():
    st.title("Continuous transport equation benchmark", anchor=False)
    ...
    This is with smooth initial data.
    """
    )
    ...
    ## Read the data
    data = read_data("cont_tran", model, hyperparams_mode.replace("_", ""))
